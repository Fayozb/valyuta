          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                isUzsMain
                    ? Text('${translate?.uzbeksum}')
                    : Text(AppHelpers.getCurrencyTitleByLocale(
                ...
                Container(
                  ...
                  child: Text(
                    NumberFormat.currency(
                            symbol:
                                '${isUzsMain ? widget.currency.ccy : "UZS"}  ')
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return CurrencyHistoryItems(
                          currency: currencyHistorys[index],
